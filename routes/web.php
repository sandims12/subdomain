...
use App\Http\Controllers\SkpdTemplateController;
...
Route::middleware(['auth', 'role:admin'])
    ...
    // AJAX subkategori berdasarkan kategori
    Route::get('categories/{category}/subcategories',
        [SubcategoryController::class, 'getSubcategories']
    )->name('categories.subcategories');

    // ✅ Template Surat Pengajuan
    Route::get('/template', [AdminTemplateController::class, 'index'])->name('template.index');
    Route::post('/template', [AdminTemplateController::class, 'store'])->name('template.store');
});
...
Route::middleware(['auth', 'role:skpd'])
    ...
    // ✅ Template Surat Pengajuan (SKPD)
    Route::get('/template', [SkpdTemplateController::class, 'index'])->name('template.index');
    Route::get('/template/download/{id}', [SkpdTemplateController::class, 'download'])->name('template.download');
});